...
const PaketLayananAdm = () => {
  ...
  return (
    <>
      <Breadcrumb pageName="Paket Makanan Aula" />
            ...
            <div className="mb-8 flex items-center justify-between gap-8">
              <div>
                <Typography variant="h5" color="blue-gray">
                  Daftar Paket Makanan Aula
                </Typography>
                <Typography color="gray" className="mt-1 font-normal">
                  Melihat informasi semua paket makanan aula yang ada
                </Typography>
              </div>
              <div className="flex shrink-0 flex-col gap-2 sm:flex-row">
                <Button
                  ...
                  size="sm"
                  onClick={() => navigate('/aula/paket/input')}
                >
...
export default PaketLayananAdm;
