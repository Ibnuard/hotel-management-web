...
const LayananKamarAdm = () => {
  ...
  function onEditData(item: any) {
    navigate(`/admin/layanan-kamar/${item.id}`, { state: item });
  }
  ...
  return (
    <>
      <Breadcrumb pageName="Manajemen Layanan Kamar" />
            ...
            <div className="mb-8 flex items-center justify-between gap-8">
              <div>
                <Typography variant="h5" color="blue-gray">
                  Daftar Layanan Kamar
                </Typography>
                <Typography color="gray" className="mt-1 font-normal">
                  Melihat informasi semua layanan kamar yang ada
                </Typography>
              </div>
              <div className="flex shrink-0 flex-col gap-2 sm:flex-row">
                <Button
                  ...
                  size="sm"
                  onClick={() => navigate('/admin/layanan-kamar/input')}
                >
...
export default LayananKamarAdm;
